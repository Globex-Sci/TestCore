        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsReview = table.Column<bool>(type: "bool", nullable: false),
                    ReviewedArticleHash = table.Column<string>(type: "text", nullable: true),
                    ReviewedArticleMark = table.Column<int>(type: "int4", nullable: false),
                    Text = table.Column<string>(type: "text", nullable: true),
                    Title = table.Column<string>(type: "text", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Articles", x => x.ArticleHash);
                });
